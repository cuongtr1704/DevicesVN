...
<div class="container my-5">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-8">
            <h1 class="display-5 fw-bold"><?= isset($category) ? escape($category['name']) : 'All Products' ?></h1>
            <?php if (isset($category) && !empty($category['description'])): ?>
                <p class="lead text-muted"><?= escape($category['description']) ?></p>
            <?php endif; ?>
        </div>
    ...
    <div class="row mb-3 d-none d-lg-flex">
        <div class="col-lg-4">
            ...
            <select class="form-select" onchange="if(this.value) window.location.href=this.value">
                <option value="<?= url('products') ?>" <?= !isset($category) ? 'selected' : '' ?>>All Products</option>
                <option value="<?= url('products/featured') ?>">⭐ Featured Products</option>
        ...
        <div class="offcanvas-body">
            ...
            <div class="mb-4">
                ...
                <select class="form-select" onchange="if(this.value) window.location.href=this.value">
                    ...
                    <?php if (!empty($categories)): ?>
                        <?php foreach ($categories as $cat): ?>
                        <option value="<?= url('products/category/' . $cat['slug']) ?>" <?= (isset($category) && $category['id'] == $cat['id']) ? 'selected' : '' ?>><?= escape($cat['name']) ?></option>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </select>
            </div>
            ...
            <div class="mb-4">
                ...
                <form method="GET" action="" onsubmit="return validatePriceRange(this, 'mobile')">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="min_price" id="mobile_min_price" class="form-control" placeholder="" 
